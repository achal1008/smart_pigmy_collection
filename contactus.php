			...
			<div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Contact Us</h1>
					...
					<div class="container">
						<div class="row">
							<div class="cell-7 contact-form fx" data-animate="fadeInLeft">
                                ...
                                <ul>
            					    <li class="footer-contact"><i class="fa fa-home"></i><span>Chand shirdwad</span></li>
            					    <li class="footer-contact"><i class="fa fa-globe"></i><span><a href="mailto:test@test.com">achalpatil009@gmail.com</a></span></li>
            					    <li class="footer-contact"><i class="fa fa-phone"></i><span>+91 8296784108</span></li>
            				    </ul>
			    			</div>
