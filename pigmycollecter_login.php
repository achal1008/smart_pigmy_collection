			...
			<div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Pigmy Collector Login</h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate">/</span><span>Pigmy Collector Login</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="cell-7 contact-form">
			    				<h3 class="block-head">Pigmy Collector Login</h3>
                                <?php
                                if($_GET['error'])
                                {
                                    ?>
                                ...
                                ?>
			    				<form action="check_pigmy_collector.php" id="reg_form" method="post" onsubmit="return validate_form();">
